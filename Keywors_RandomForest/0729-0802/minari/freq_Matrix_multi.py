...
# createDirectory('./python_TF-IDF_%s'%args.lang+'/keywords2000')
createDirectory('./python_TF-IDF_%s'%args.lang+'/keywords2000_constant2')
# pd.DataFrame(data_metric).to_csv('./python_TF-IDF_%s'%args.lang+'/keywords2000/metric_for_paper_200.csv', index=False)
pd.DataFrame(data_metric).to_csv('./python_TF-IDF_%s'%args.lang+'/keywords2000_constant2/metric_for_paper_200.csv', index=False)
...
complete_table.to_csv('./python_TF-IDF_%s'%args.lang+'/keywords2000_constant2/complete_table_200.csv')
...
for name in names:
    data_metric = pd.DataFrame(pd.read_csv('./python_TF-IDF_%s'%args.lang+'/keywords2000_constant2/metric_for_paper_200.csv'))
    data_metric.sort_values(by=[name], ascending=False, inplace=True)
    keywords = data_metric['keywords'].tolist()
    pd.DataFrame(keywords).to_csv('./python_TF-IDF_%s'%args.lang+'/keywords2000_constant2/%s.csv'%name, index=False, header=False)
    total_data = pd.read_csv('./python_TF-IDF_%s'%args.lang+'/keywords2000_constant2/complete_table_200.csv', index_col='Unnamed: 0').T[keywords[:2000]]
    total_data.to_csv('./python_TF-IDF_%s'%args.lang+'/keywords2000_constant2/frequency_matrix_200_%s.csv'%name)
...
pd.DataFrame(data_metric).to_csv('./python_TF-IDF_%s'%args.lang+'/keywords2000_constant2/metric_for_paper_ctfidf_200.csv', index=False)

for name in ['ctfidf']:
    data_metric = pd.DataFrame(pd.read_csv('./python_TF-IDF_%s'%args.lang+'/keywords2000_constant2/metric_for_paper_ctfidf_200.csv'))
    data_metric.sort_values(by=[name], ascending=False, inplace=True)
    keywords = pd.read_csv('./python_TF-IDF_%s'%args.lang+'/keywords_200.csv')['word'].tolist()
