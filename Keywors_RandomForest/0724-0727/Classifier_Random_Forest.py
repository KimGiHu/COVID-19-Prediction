...
names = ['soykeyword_metric1', 'soykeyword_metric2', 'soykeyword_metric3'] + ['rev_metric1', 'rev_metric2', 'rev_metric3']
...
for name in names:
    datas[name] = {}
    mat = pd.read_csv('./python_TF-IDF/frequency_matrix_200_{}.csv'.format(name), index_col=0)
...
t = pd.read_csv('./python_TF-IDF/key_dates_US.csv', index_col='date')['label']
