...
# train_dates = pd.date_range(start='2020-01-01', end='2021-06-30', freq='D').tolist()
# val_dates = pd.date_range(start='2021-07-01', end='2021-12-31', freq='D').tolist() 
# test_dates = pd.date_range(start='2022-01-01', end='2022-06-30', freq='D').tolist() 
...
createDirectory(path+'/keywords2000_noun')
pd.DataFrame(data_metric).to_csv('./python_TF-IDF_%s'%args.lang+'/keywords2000_noun/metric_for_paper_%s.csv'%args.count, index=False)
...
complete_table.to_csv(path+'/keywords2000_noun/complete_table_%s.csv'%args.count)
...
for name in names:
    data_metric = pd.DataFrame(pd.read_csv('./python_TF-IDF_%s'%args.lang+'/keywords2000_noun/metric_for_paper_%s.csv'%args.count))
    ...
    pd.DataFrame(keywords).to_csv('./python_TF-IDF_%s'%args.lang+'/keywords2000_noun/%s.csv'%name, index=False, header=False)
    total_data = pd.read_csv('./python_TF-IDF_%s'%args.lang+'/keywords2000_noun/complete_table_%s.csv'%args.count, index_col='Unnamed: 0').T[keywords[:2000]]
    total_data.to_csv('./python_TF-IDF_%s'%args.lang+'/keywords2000_noun/frequency_matrix_%s'%args.count+'_%s.csv'%name)
...
pd.DataFrame(data_metric).to_csv('./python_TF-IDF_%s'%args.lang+'/keywords2000_noun/metric_for_paper_ctfidf_%s.csv'%args.count, index=False)
...
for name in ['ctfidf']:
    ...
    data_metric = pd.DataFrame(pd.read_csv('./python_TF-IDF_%s'%args.lang+'/keywords2000_noun/metric_for_paper_ctfidf_%s.csv'%args.count))
    data_metric.sort_values(by=[name], ascending=False, inplace=True)
