...
train_dates = pd.date_range(start='2020-01-01', end='2020-12-31', freq='D').tolist()
val_dates = pd.date_range(start='2021-01-01', end='2021-04-30', freq='D').tolist() 
test_dates = pd.date_range(start='2021-05-01', end='2021-08-31', freq='D').tolist() 
...
pd.DataFrame(data_metric).to_csv('./python_TF-IDF_%s'%args.lang+'/keywords2000_noun_month/metric_for_paper_%s.csv'%args.count, index=False)
